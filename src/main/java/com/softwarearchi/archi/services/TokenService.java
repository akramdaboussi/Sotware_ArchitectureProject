...
import com.softwarearchi.archi.models.TokenType;
...
public class TokenService {
    ...
    public TokenService(InMemoryStorage storage) {
    ...
    public boolean validateToken(String tokenValue) {
        ...
        Token token = storage.findTokenByValue(tokenValue);
    ...
    public void revokeToken(String tokenValue) {
        ...
        if (token != null) {
            ...
            logger.warn("[SERVICE-TOKEN] ⚠️ Attempted to revoke non-existent token");
        }
    }
